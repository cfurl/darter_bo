...
tags$body(
    ...
    tags$main(
      ...
      tags$div(class="EAHCP-biol-obj-wg",
        tags$h1("EAHCP Biological Objectives Work Group"),
        tags$p("This webpage serves as an electronic supplement for the Edwards Aquifer Habitat Conservation 
              Plan - Biological Objectives Work Group - Fountain Darter/SAV team. This Work Group is part of the EAHCP 
              Permit Renewal effort and will serve as an avenue for species experts and other stakeholders to develop 
              recommendations for updating EAHCP Covered Species Biological Objectives. The Work Group has been assigned 
              the following tasks:"),
        tags$ol(
          ...
          tags$li("Examine existing biological objectives and develop updated draft biological objectives adhering to HCP 
        ...
        tags$p("The USFWS Habitat Planning Handbook (2016) provides guidance on developing Biological Objectives in" ,
          ...
          tags$a (href="https://www.fws.gov/sites/default/files/documents/habitat-conservation-planning-handbook-chapter-9.pdf", 
                ...
                "I would encourage Work Group members to read the short section covering Biological Goals and Biological Objectives. 
                  Below is a brief summary of pertinent information retrieved from sections 9.1 Biological Goals and 9.2 Biological Objectives."
               ),
        tags$div(class="handbook-text",
                 tags$p("It takes careful thought to develop productive and meaningful goals, and it is a critical step. In a few concise statements,
                        goals comprise the HCP’s effort in pursuit of its vision and lay the foundation from which all conservation activities arise. 
                        Management activities result from goals, and not the other way around. Goals must be developed before developing objectives and conservation 
                        measures to orient management direction, both during plan development and throughout implementation.  Objectives are the incremental steps 
                        taken to achieve a goal. Objectives are derived from goals, and they provide a foundation for determining conservation measures, monitoring 
                        direction, and evaluating effectiveness of the conservation strategy. The number of objectives per goal will vary, but there should be 
                        enough to adequately describe how to achieve the goal. An implementation schedule may be beneficial if a goal has several objectives.")   
     ...
     tags$div(class="examples",
          tags$h2("Example Biological Goals and Objectives"),
            tags$p("Long-term Biological Goal - Bogus Bat: self-sustaining population of bogus bats in the preserve system that can withstand threats, 
                   is genetically representative of neighboring populations, and contributes to the overall recovery of the species."),
            tags$ol(
              tags$li("Objective: Preserve 50% of the hibernacula and all maternity roosts of the bogus bat, in the plan area during the permit term"),
              tags$li("Objective:Enhance roosting habitat by protection and restoring any abandoned mine, cave, or building in the Preserve System and, 
                      if feasible, creating 5 artificial hibernacula during the permit term.")
                  ),
            tags$p("Long-term Biological Goal - Swamp habitat: hydrologic integrity of the Mucky Swamp within the natural state of variability and 
                   function maintained within future climatic constraints."),
            tags$ol(
              tags$li("Objective: preserve all area within 2500 feet of the 1900 high water line of Mucky swamp within 10 years of permit issuance through 
                      conservation easements and acquisition in fee title."),
              tags$li("Objective: restore historic contours and elevations of Mucky swamp to increase retention and infill of sediment within 3 years of land preservation."),
              tags$li("Objective: restore vegetation to historical conditions on preserved lands to increase infill into the Mucky Swamp from Stinky Creek and Curvey Creek 
      ...
      tags$div(class="recommendations",
          tags$h2("Biological Goals Work Group Recommendation"),
            tags$p("Fountain darter - Conserve habitats and diverse native aquatic vegetation assemblages to support resilient fountain
                   darter populations in the Comal and San Marcos spring and river systems."),
          tags$p("TWR - Conserve and manage resilient TWR populations in the San Marcos spring and river system.")
        ...
        tags$h2("Existing Biological Goals and Objectives"),
          tags$p(
            tags$a(href="https://www.edwardsaquifer.org/wp-content/uploads/2022/07/Edwards-Aquifer-Recovery-Implementation-Program-Nov-2021.pdf",
                ...
                "contains the exisiting Biological Objectives for TWR and the Fountain Darter (Comal species - 4.1.1.1 and San Marcos species - 4.1.1.2)."),
        ...
        tags$h3("Texas Wild-rice"),
           tags$p("There are three Biological Objectives that accompany the Biological Goals for TWR in the San Marcos."),
                 tags$ol(
                  ...
                  tags$li("Active restoration and Texas wild-rice expansion efforts and long-term monitoring focused on high-quality habitat areas."),     tags$p("The long-term biological goals for Texas Wild-Rice are areal coverage of Texas Wild-Rice within specific river reaches of the San Marcos River."),
